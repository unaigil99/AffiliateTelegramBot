...
def start(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Kaixooo! Este bot responde a los enlaces de amazon añadiendo un codigo de afiliado! Eskerrik asko zure laguntzagatik :)")
